...
### 🔧 Skills
- **R** — Shiny, ggplot2, dplyr, statistical analysis
...
- KPI summary cards (avg range, CO2 saved, battery health, resale value)
- Distribution, composition, geographic map, and correlation views
- Dynamic filters by region, vehicle type, use case, and year range
- Combined bar + trend line charts and cross-tab analysis
...
<!--
**Ortiz2-7/Ortiz2-7** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
